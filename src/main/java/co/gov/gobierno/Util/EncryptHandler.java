...
public class EncryptHandler
{
	...
	private static final org.slf4j.Logger log = LoggerFactory.getLogger(EncryptHandler.class);
    ...
    public static String encrypt(String key, String initVector, String value)
    {
        ...
        {
            log.error("Error al encriptar la cadena.");
        }
        return null;
    }
    ...
    public static String decrypt(String key, String initVector, String encrypted)
    {
        ...
        {
            log.error("Error al desencriptar la cadena.");
        }
