...
public class PHUpdateLegalAgentController implements Serializable
{
    ...
    public String updateLegalAgent()
    {
            ...
            if (true)
            {
                ...
                if(radNumber!=null && !radNumber.equals(""))
                {
                    ...
                    else
                    {
                        ...
                        this.setModalAlertShow(true);
                        this.setModalAlertStyle(false);
                        this.setModalAlertMessage("Ocurrió un error numero del anexo vacio contacte al administrador del sistema.");
                ...
                else
                {
                    ...
                    this.setModalAlertShow(true);
                    this.setModalAlertStyle(false);
                    this.setModalAlertMessage("Ocurrió un error numero de radicado vacio contacte al administrador del sistema.");
                    // this.setModalAlertMessage("Ocurrió un error inesperado en el sistema contacte al administrador del sistema.");
                }
            }
            else
        ...
        } catch (Exception e)
        {
            ...
            this.setModalAlertShow(true);
            this.setModalAlertStyle(false);
            this.setModalAlertMessage("Ocurrió un error error al registrar el formulario contacte al administrador del sistema.");
            // this.setModalAlertMessage("Ocurrió un error inesperado en el sistema contacte al administrador del sistema.");
        }
        return null;
    }
